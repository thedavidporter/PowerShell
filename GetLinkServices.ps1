# 9/8/2025:  David Porter
# Comments:  Base script comes from https://github.com/Azure/Azure-DataFactory/blob/main/Connector/FindImpactedObjects.ps1
...
Install-Module -Scope CurrentUser -Name Az.DataFactory -Force -AllowClobber
